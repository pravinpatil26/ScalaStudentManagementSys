...
package controllers {
  ...
  class ReverseApplication(_prefix: => String) {
    ...
    // @LINE:17
    def examStudentUpdate(id:String): Call = {
      
      Call("GET", _prefix + { _defaultPrefix } + "examStudentUpdate" + play.core.routing.queryString(List(Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("id", id)))))
    }
