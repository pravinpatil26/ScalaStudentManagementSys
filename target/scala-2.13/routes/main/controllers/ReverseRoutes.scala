...
package controllers {
  ...
  class ReverseApplication(_prefix: => String) {
    ...
    // @LINE:70
    def instituteUpdate(student_first_name:String, student_mid_name:String, student_last_name:String, stu_registration_Id:Int, prev_name:String, prev_code:String, prev_email:String, prev_contact:String, prev_line1:String, prev_line2:String, prev_city:String, prev_district:String, prev_state:String, prev_country:String, prev_pin:String, prev_year:String, current_name:String, current_code:String, current_email:String, current_contact:String, current_line1:String, current_line2:String, current_city:String, current_district:String, current_state:String, current_country:String, current_pin:String, get_id:String): Call = {
      
      Call("GET", _prefix + { _defaultPrefix } + "instituteUpdate" + play.core.routing.queryString(List(Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("student_first_name", student_first_name)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("student_mid_name", student_mid_name)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("student_last_name", student_last_name)), Some(implicitly[play.api.mvc.QueryStringBindable[Int]].unbind("stu_registration_Id", stu_registration_Id)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_name", prev_name)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_code", prev_code)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_email", prev_email)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_contact", prev_contact)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_line1", prev_line1)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_line2", prev_line2)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_city", prev_city)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_district", prev_district)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_state", prev_state)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_country", prev_country)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_pin", prev_pin)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_year", prev_year)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_name", current_name)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_code", current_code)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_email", current_email)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_contact", current_contact)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_line1", current_line1)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_line2", current_line2)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_city", current_city)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_district", current_district)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_state", current_state)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_country", current_country)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_pin", current_pin)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("get_id", get_id)))))
    }
    ...
    // @LINE:67
    def instituteGetValues(student_first_name:String, student_mid_name:String, student_last_name:String, stu_registration_Id:Int, prev_name:String, prev_code:String, prev_email:String, prev_contact:String, prev_line1:String, prev_line2:String, prev_city:String, prev_district:String, prev_state:String, prev_country:String, prev_pin:String, prev_year:String, current_name:String, current_code:String, current_email:String, current_contact:String, current_line1:String, current_line2:String, current_city:String, current_district:String, current_state:String, current_country:String, current_pin:String): Call = {
      
      Call("GET", _prefix + { _defaultPrefix } + "instituteForm" + play.core.routing.queryString(List(Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("student_first_name", student_first_name)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("student_mid_name", student_mid_name)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("student_last_name", student_last_name)), Some(implicitly[play.api.mvc.QueryStringBindable[Int]].unbind("stu_registration_Id", stu_registration_Id)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_name", prev_name)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_code", prev_code)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_email", prev_email)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_contact", prev_contact)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_line1", prev_line1)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_line2", prev_line2)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_city", prev_city)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_district", prev_district)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_state", prev_state)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_country", prev_country)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_pin", prev_pin)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prev_year", prev_year)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_name", current_name)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_code", current_code)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_email", current_email)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_contact", current_contact)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_line1", current_line1)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_line2", current_line2)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_city", current_city)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_district", current_district)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_state", current_state)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_country", current_country)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("current_pin", current_pin)))))
    }
  
    // @LINE:68
    def instituteDelete(stu_registration_Id:Int): Call = {
      
      Call("GET", _prefix + { _defaultPrefix } + "instituteDelete" + play.core.routing.queryString(List(Some(implicitly[play.api.mvc.QueryStringBindable[Int]].unbind("stu_registration_Id", stu_registration_Id)))))
    }
    ...
    // @LINE:52
    def studentGetValues(student_first_name:String, student_mid_name:String, student_last_name:String, line1:String, line2:String, city:String, district:String, state:String, country:String, pincode:String, student_dob:String, student_mob_no:String, student_email:String, father_first_name:String, father_mid_name:String, father_last_name:String, father_mob_no:String, father_email:String, mother_first_name:String, mother_mob_no:String, mother_email:String, govt_id_details:String): Call = {
      
      Call("GET", _prefix + { _defaultPrefix } + "studentForm" + play.core.routing.queryString(List(Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("student_first_name", student_first_name)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("student_mid_name", student_mid_name)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("student_last_name", student_last_name)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("line1", line1)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("line2", line2)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("city", city)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("district", district)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("state", state)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("country", country)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("pincode", pincode)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("student_dob", student_dob)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("student_mob_no", student_mob_no)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("student_email", student_email)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("father_first_name", father_first_name)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("father_mid_name", father_mid_name)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("father_last_name", father_last_name)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("father_mob_no", father_mob_no)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("father_email", father_email)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("mother_first_name", mother_first_name)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("mother_mob_no", mother_mob_no)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("mother_email", mother_email)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("govt_id_details", govt_id_details)))))
    }
    ...
    // @LINE:69
    def instituteView(stu_registration_Id:Int): Call = {
      
      Call("GET", _prefix + { _defaultPrefix } + "instituteView" + play.core.routing.queryString(List(Some(implicitly[play.api.mvc.QueryStringBindable[Int]].unbind("stu_registration_Id", stu_registration_Id)))))
    }
