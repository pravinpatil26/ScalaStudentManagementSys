...
package controllers {
  ...
  class ReverseApplication(_prefix: => String) {
    ...
    // @LINE:35
    def insertExamDetail(): Call = {
      
      Call("POST", _prefix + { _defaultPrefix } + "insertExamDetail")
    }
    ...
    // @LINE:18
    def deleteExamRecord(prn:String, acad_year:String): Call = {
      
      Call("GET", _prefix + { _defaultPrefix } + "deleteExamStudent" + play.core.routing.queryString(List(Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prn", prn)), Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("acad_year", acad_year)))))
    }
    ...
    // @LINE:33
    def fetchExamStudent(): Call = {
      
      Call("GET", _prefix + { _defaultPrefix } + "fetchExamStudent")
    }
    ...
    // @LINE:32
    def fetchStudent(): Call = {
      
      Call("GET", _prefix + { _defaultPrefix } + "fetchStudent")
    }
    ...
    // @LINE:16
    def examDetailUpdate(prn:String, acad_year:String): Call = {
    
      (prn: @unchecked, acad_year: @unchecked) match {
      
        // @LINE:16
        case (prn, acad_year)  =>
          
          Call("POST", _prefix + { _defaultPrefix } + "updateExam" + play.core.routing.queryString(List(if(prn == "") None else Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("prn", prn)), if(acad_year == "") None else Some(implicitly[play.api.mvc.QueryStringBindable[String]].unbind("acad_year", acad_year)))))
    ...
    def index(): Call = {
      ...
      Call("GET", _prefix + { _defaultPrefix } + "insertExamStudent")
    }
