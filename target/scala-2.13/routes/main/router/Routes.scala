...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """instituteForm""", """controllers.Application.instituteGetValues(student_first_name:String, student_mid_name:String, student_last_name:String, stu_registration_Id:Int, prev_name:String, prev_code:String, prev_email:String, prev_contact:String, prev_line1:String, prev_line2:String, prev_city:String, prev_district:String, prev_state:String, prev_country:String, prev_pin:String, prev_year:String, current_name:String, current_code:String, current_email:String, current_contact:String, current_line1:String, current_line2:String, current_city:String, current_district:String, current_state:String, current_country:String, current_pin:String)"""),
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """instituteDelete""", """controllers.Application.instituteDelete(stu_registration_Id:Int)"""),
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """instituteView""", """controllers.Application.instituteView(stu_registration_Id:Int)"""),
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """instituteUpdate""", """controllers.Application.instituteUpdate(student_first_name:String, student_mid_name:String, student_last_name:String, stu_registration_Id:Int, prev_name:String, prev_code:String, prev_email:String, prev_contact:String, prev_line1:String, prev_line2:String, prev_city:String, prev_district:String, prev_state:String, prev_country:String, prev_pin:String, prev_year:String, current_name:String, current_code:String, current_email:String, current_contact:String, current_line1:String, current_line2:String, current_city:String, current_district:String, current_state:String, current_country:String, current_pin:String, get_id:String)"""),
...
GET     /tutorial                           controllers.HomeController.tutorial()""",
  ...
  private[this] lazy val controllers_Application_instituteGetValues37_invoker = createInvoker(
    Application_0.instituteGetValues(fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[Int], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "instituteGetValues",
      Seq(classOf[String], classOf[String], classOf[String], classOf[Int], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String]),
      "GET",
  ...
  private[this] lazy val controllers_Application_instituteDelete38_invoker = createInvoker(
    Application_0.instituteDelete(fakeValue[Int]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "instituteDelete",
  ...
  private[this] lazy val controllers_Application_instituteView39_invoker = createInvoker(
    Application_0.instituteView(fakeValue[Int]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "instituteView",
  ...
  private[this] lazy val controllers_Application_instituteUpdate40_invoker = createInvoker(
    Application_0.instituteUpdate(fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[Int], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String], fakeValue[String]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "instituteUpdate",
      Seq(classOf[String], classOf[String], classOf[String], classOf[Int], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String], classOf[String]),
      "GET",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_Application_studentGetValues28_route(params@_) =>
      call(List(params.fromQuery[String]("student_first_name", None), params.fromQuery[String]("student_mid_name", None), params.fromQuery[String]("student_last_name", None), params.fromQuery[String]("line1", None), params.fromQuery[String]("line2", None), params.fromQuery[String]("city", None), params.fromQuery[String]("district", None), params.fromQuery[String]("state", None), params.fromQuery[String]("country", None), params.fromQuery[String]("pincode", None), params.fromQuery[String]("student_dob", None), params.fromQuery[String]("student_mob_no", None), params.fromQuery[String]("student_email", None), params.fromQuery[String]("father_first_name", None), params.fromQuery[String]("father_mid_name", None), params.fromQuery[String]("father_last_name", None), params.fromQuery[String]("father_mob_no", None), params.fromQuery[String]("father_email", None), params.fromQuery[String]("mother_first_name", None), params.fromQuery[String]("mother_mob_no", None), params.fromQuery[String]("mother_email", None), params.fromQuery[String]("govt_id_details", None))) { case (student_first_name: String):: (student_mid_name: String):: (student_last_name: String):: (line1: String):: (line2: String):: (city: String):: (district: String):: (state: String):: (country: String):: (pincode: String):: (student_dob: String):: (student_mob_no: String):: (student_email: String):: (father_first_name: String):: (father_mid_name: String):: (father_last_name: String):: (father_mob_no: String):: (father_email: String):: (mother_first_name: String):: (mother_mob_no: String):: (mother_email: String):: (govt_id_details: String) :: Nil =>
        controllers_Application_studentGetValues28_invoker.call(Application_0.studentGetValues(student_first_name, student_mid_name, student_last_name, line1, line2, city, district, state, country, pincode, student_dob, student_mob_no, student_email, father_first_name, father_mid_name, father_last_name, father_mob_no, father_email, mother_first_name, mother_mob_no, mother_email, govt_id_details))
      }
    ...
    case controllers_Application_instituteGetValues37_route(params@_) =>
      call(List(params.fromQuery[String]("student_first_name", None), params.fromQuery[String]("student_mid_name", None), params.fromQuery[String]("student_last_name", None), params.fromQuery[Int]("stu_registration_Id", None), params.fromQuery[String]("prev_name", None), params.fromQuery[String]("prev_code", None), params.fromQuery[String]("prev_email", None), params.fromQuery[String]("prev_contact", None), params.fromQuery[String]("prev_line1", None), params.fromQuery[String]("prev_line2", None), params.fromQuery[String]("prev_city", None), params.fromQuery[String]("prev_district", None), params.fromQuery[String]("prev_state", None), params.fromQuery[String]("prev_country", None), params.fromQuery[String]("prev_pin", None), params.fromQuery[String]("prev_year", None), params.fromQuery[String]("current_name", None), params.fromQuery[String]("current_code", None), params.fromQuery[String]("current_email", None), params.fromQuery[String]("current_contact", None), params.fromQuery[String]("current_line1", None), params.fromQuery[String]("current_line2", None), params.fromQuery[String]("current_city", None), params.fromQuery[String]("current_district", None), params.fromQuery[String]("current_state", None), params.fromQuery[String]("current_country", None), params.fromQuery[String]("current_pin", None))) { case (student_first_name: String):: (student_mid_name: String):: (student_last_name: String):: (stu_registration_Id: Int):: (prev_name: String):: (prev_code: String):: (prev_email: String):: (prev_contact: String):: (prev_line1: String):: (prev_line2: String):: (prev_city: String):: (prev_district: String):: (prev_state: String):: (prev_country: String):: (prev_pin: String):: (prev_year: String):: (current_name: String):: (current_code: String):: (current_email: String):: (current_contact: String):: (current_line1: String):: (current_line2: String):: (current_city: String):: (current_district: String):: (current_state: String):: (current_country: String):: (current_pin: String) :: Nil =>
        controllers_Application_instituteGetValues37_invoker.call(Application_0.instituteGetValues(student_first_name, student_mid_name, student_last_name, stu_registration_Id, prev_name, prev_code, prev_email, prev_contact, prev_line1, prev_line2, prev_city, prev_district, prev_state, prev_country, prev_pin, prev_year, current_name, current_code, current_email, current_contact, current_line1, current_line2, current_city, current_district, current_state, current_country, current_pin))
      }
  
    // @LINE:68
    case controllers_Application_instituteDelete38_route(params@_) =>
      call(params.fromQuery[Int]("stu_registration_Id", None)) { (stu_registration_Id) =>
        controllers_Application_instituteDelete38_invoker.call(Application_0.instituteDelete(stu_registration_Id))
      }
  
    // @LINE:69
    case controllers_Application_instituteView39_route(params@_) =>
      call(params.fromQuery[Int]("stu_registration_Id", None)) { (stu_registration_Id) =>
        controllers_Application_instituteView39_invoker.call(Application_0.instituteView(stu_registration_Id))
      }
  
    // @LINE:70
    case controllers_Application_instituteUpdate40_route(params@_) =>
      call(List(params.fromQuery[String]("student_first_name", None), params.fromQuery[String]("student_mid_name", None), params.fromQuery[String]("student_last_name", None), params.fromQuery[Int]("stu_registration_Id", None), params.fromQuery[String]("prev_name", None), params.fromQuery[String]("prev_code", None), params.fromQuery[String]("prev_email", None), params.fromQuery[String]("prev_contact", None), params.fromQuery[String]("prev_line1", None), params.fromQuery[String]("prev_line2", None), params.fromQuery[String]("prev_city", None), params.fromQuery[String]("prev_district", None), params.fromQuery[String]("prev_state", None), params.fromQuery[String]("prev_country", None), params.fromQuery[String]("prev_pin", None), params.fromQuery[String]("prev_year", None), params.fromQuery[String]("current_name", None), params.fromQuery[String]("current_code", None), params.fromQuery[String]("current_email", None), params.fromQuery[String]("current_contact", None), params.fromQuery[String]("current_line1", None), params.fromQuery[String]("current_line2", None), params.fromQuery[String]("current_city", None), params.fromQuery[String]("current_district", None), params.fromQuery[String]("current_state", None), params.fromQuery[String]("current_country", None), params.fromQuery[String]("current_pin", None), params.fromQuery[String]("get_id", None))) { case (student_first_name: String):: (student_mid_name: String):: (student_last_name: String):: (stu_registration_Id: Int):: (prev_name: String):: (prev_code: String):: (prev_email: String):: (prev_contact: String):: (prev_line1: String):: (prev_line2: String):: (prev_city: String):: (prev_district: String):: (prev_state: String):: (prev_country: String):: (prev_pin: String):: (prev_year: String):: (current_name: String):: (current_code: String):: (current_email: String):: (current_contact: String):: (current_line1: String):: (current_line2: String):: (current_city: String):: (current_district: String):: (current_state: String):: (current_country: String):: (current_pin: String):: (get_id: String) :: Nil =>
        controllers_Application_instituteUpdate40_invoker.call(Application_0.instituteUpdate(student_first_name, student_mid_name, student_last_name, stu_registration_Id, prev_name, prev_code, prev_email, prev_contact, prev_line1, prev_line2, prev_city, prev_district, prev_state, prev_country, prev_pin, prev_year, current_name, current_code, current_email, current_contact, current_line1, current_line2, current_city, current_district, current_state, current_country, current_pin, get_id))
      }
